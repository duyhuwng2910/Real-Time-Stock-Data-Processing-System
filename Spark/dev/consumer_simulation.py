...
def process_real_time_stock_trading_data(json_df):
    json_schema = (StructType()
                   ...
                   .add("Open", IntegerType(), False)
                   .add("High", IntegerType(), False)
                   .add("Low", IntegerType(), False)
                   .add("Close", IntegerType(), False)
    ...
    stock_df = stock_df.withColumn("TradingDate", to_date(stock_df['TradingDate'], "yyyy-MM-dd"))
